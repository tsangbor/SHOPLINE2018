...
class CategoryPosts extends WP_Widget {
	...
	function CategoryPosts() {
		$widget_ops = array('classname' => 'cat-post-widget', 'description' => __('List single category posts for your Bloggr sidebars'));
		parent::__construct('category-posts', __('SHOPLINE: Sidebar Category Posts'), $widget_ops); 
	}
